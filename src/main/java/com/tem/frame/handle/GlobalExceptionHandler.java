...
import com.tem.frame.wrapper.NotWrapper;
...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    public GlobalResponseWrapper customExceptionHandler(HttpServletRequest request, GlobalException exception) throws Exception {
